// ============================================================================
// Comprehensive Visa Pathways Data Registry for 14 Major Destination Countries
// Covers Full Lifecycle: PR Direct, Points-based, Work, Post-study PSW, WHV, Talent, Opportunity & Investment
// ============================================================================

import type { CountryCode, AdvisorVerdict } from '@emigrant/shared';

export type VisaPillCategory =
  | 'pr'
  | 'work'
  | 'study_psw'
  | 'whv'
...
export interface VisaPillBadgeConfig {
  label: string;
  className: string;
}

export const VISA_CATEGORY_BADGES: Record<VisaPillCategory, VisaPillBadgeConfig> = {
  pr: {
    label: '永居 PR',
    className: 'bg-[#eaf6ed] text-[#2e7d32] border-[#c5e8ce]',
  },
  work: {
    label: '技能工签',
    className: 'bg-[#e0f2fe] text-[#0284c7] border-[#bae6fd]',
  },
  study_psw: {
    label: '毕业工签',
  ...
  whv: {
    label: '打工度假',
    className: 'bg-[#f3e8ff] text-[#9333ea] border-[#e9d5ff]',
  },
  opportunity: {
    label: '机会/找工',
    className: 'bg-[#ffedd5] text-[#ea580c] border-[#fed7aa]',
  },
  pr_transition: {
    label: '准永居过渡',
    className: 'bg-[#e0f7fa] text-[#00838f] border-[#b2ebf2]',
  },
  vocational: {
    label: '双元制/培训',
  ...
  blue_collar: {
    label: '蓝领实操',
    className: 'bg-[#fae8ff] text-[#a21caf] border-[#f5d0fe]',
  },
  talent: {
    label: '全球人才/直通',
...
export interface CountryVisaGroup {
  ...
  visas: {
    ...
    codeName: string;
    shortName: string;
    pillCategory: VisaPillCategory;
  }[];
}

export const COUNTRY_VISA_GROUPS: CountryVisaGroup[] = [
  {
    countryCode: 'NZ',
    countryName: '新西兰',
    flag: '🇳🇿',
    visas: [
      { id: 'nz_smc', codeName: 'SMC 6分制', shortName: '6分制技术移民居留签 (达标直接PR)', pillCategory: 'pr' },
      { id: 'nz_green_list', codeName: '绿名单 STR', shortName: '绿名单 Tier 1 一步到位直接永居', pillCategory: 'pr' },
      { id: 'nz_aewv', codeName: 'AEWV 雇主工签', shortName: '认证雇主工签 (最长5年/达中位数时薪)', pillCategory: 'work' },
      { id: 'nz_pswv', codeName: 'PSWV 毕业工签', shortName: '硕士/博士 3年全职开放工签', pillCategory: 'study_psw' },
      { id: 'nz_whv', codeName: 'WHV 打工度假', shortName: '中国大陆青年专属打工度假签 (1000名额)', pillCategory: 'whv' },
      { id: 'nz_investor', codeName: '积极投资者', shortName: 'Active Investor Plus (500万~1500万纽币)', pillCategory: 'investment' },
    ],
  },
  {
    countryCode: 'AU',
    ...
    flag: '🇦🇺',
    visas: [
      { id: 'au_189', codeName: '189 独立技术', shortName: '独立技术移民永居 (全澳自由定居)', pillCategory: 'pr' },
      { id: 'au_190', codeName: '190 州担保永居', shortName: '各州政府担保技术移民永居 (+5分)', pillCategory: 'pr' },
      { id: 'au_491', codeName: '491 偏远州担', shortName: '偏远地区州担准永居 (+15分/3年转191PR)', pillCategory: 'pr_transition' },
      { id: 'au_482', codeName: '482 技能短缺', shortName: 'TSS 雇主担保工签 (2年转186永居)', pillCategory: 'work' },
      { id: 'au_485', codeName: '485 毕业工签', shortName: '留学生毕业工作签 (新政卡35岁上限)', pillCategory: 'study_psw' },
      { id: 'au_858', codeName: '国家创新签证', shortName: '原全球人才 GTI 858 (免打分直接绿卡)', pillCategory: 'talent' },
    ],
  },
  {
    countryCode: 'CA',
    ...
    flag: '🇨🇦',
    visas: [
      { id: 'ca_ee', codeName: 'EE 联邦快速通道', shortName: 'CRS 评分系统 (定向Tech/Healthcare/法语)', pillCategory: 'pr' },
      { id: 'ca_pnp_tech', codeName: 'BC/ON 省提名', shortName: 'BC Tech / 安省技能优先省提名 (+600分)', pillCategory: 'pr' },
      { id: 'ca_pgwp', codeName: 'PGWP 毕业工签', shortName: '公立大学毕业工签 (最长3年开放许可)', pillCategory: 'study_psw' },
      { id: 'ca_suv', codeName: 'SUV 联邦创投', shortName: 'Start-up Visa 创业投资移民 (组团全家PR)', pillCategory: 'investment' },
    ],
  },
  {
    countryCode: 'DE',
    ...
    flag: '🇩🇪',
    visas: [
      { id: 'de_blue_card', codeName: '欧盟蓝卡', shortName: 'EU Blue Card (€41.0k门槛/21月转永居)', pillCategory: 'work' },
      { id: 'de_ausbildung', codeName: '双元制培训', shortName: '带薪职业教育 (月发津贴/包就业转绿卡)', pillCategory: 'work' },
      { id: 'de_chancenkarte', codeName: '机会卡 (Chancenkarte)', shortName: '积分制找工签证 (6分即批/1年自由找工)', pillCategory: 'opportunity' },
    ],
  },
  {
    countryCode: 'FR',
    ...
    flag: '🇫🇷',
    visas: [
      { id: 'fr_talent_passport', codeName: '优秀人才通行证', shortName: 'Passeport Talent (4年有效免劳工测试)', pillCategory: 'talent' },
      { id: 'fr_rece', codeName: 'RECE 找工居留', shortName: '硕博毕业找工与创业居留 (12个月)', pillCategory: 'study_psw' },
    ],
  },
  {
    countryCode: 'SE',
    ...
    flag: '🇸🇪',
    visas: [
      { id: 'se_work_permit', codeName: '技能工作许可', shortName: '新政月薪 28,480 SEK (4年转永居)', pillCategory: 'work' },
      { id: 'se_job_seeker', codeName: '毕业找工签', shortName: '高等教育毕业生找工居留 (1年)', pillCategory: 'opportunity' },
    ],
  },
  {
    countryCode: 'DK',
    ...
    flag: '🇩🇰',
    visas: [
      { id: 'dk_positive_list', codeName: 'Positive List', shortName: '高教紧缺职业清单工签', pillCategory: 'work' },
      { id: 'dk_pay_limit', codeName: 'Pay Limit', shortName: '高薪上限计划工签 (年薪超487k)', pillCategory: 'work' },
      { id: 'dk_establishment', codeName: 'Establishment Card', shortName: '丹麦留学生找工卡 (最长3年)', pillCategory: 'study_psw' },
    ],
  },
  {
    countryCode: 'FI',
    ...
    flag: '🇫🇮',
    visas: [
      { id: 'fi_specialist', codeName: 'Specialist Fast-track', shortName: '特聘专家工签 (2周极速获批)', pillCategory: 'work' },
      { id: 'fi_post_study', codeName: '毕业找工居留', shortName: '芬兰毕业生 2 年找工居留 (全欧最长)', pillCategory: 'study_psw' },
    ],
  },
  {
    countryCode: 'GB',
    ...
    flag: '🇬🇧',
    visas: [
      { id: 'uk_skilled_worker', codeName: 'Skilled Worker', shortName: '技术工作签证 (£38.7k门槛)', pillCategory: 'work' },
      { id: 'uk_graduate_visa', codeName: 'Graduate Visa', shortName: '毕业生签证 (享2年停留找工)', pillCategory: 'study_psw' },
      { id: 'uk_hpi', codeName: 'HPI 高潜力人才', shortName: '全球 Top 50 名校毕业生找工工签', pillCategory: 'opportunity' },
      { id: 'uk_global_talent', codeName: 'Global Talent', shortName: '全球人才签证 (免雇主3年永居)', pillCategory: 'talent' },
    ],
  },
  {
    countryCode: 'IE',
    ...
    flag: '🇮🇪',
    visas: [
      { id: 'ie_csep', codeName: 'CSEP 关键技能', shortName: '关键技能工作许可 (21月转Stamp4)', pillCategory: 'work' },
      { id: 'ie_stamp1g', codeName: 'Stamp 1G', shortName: '第三级毕业生找工居留 (Stay Back 2年)', pillCategory: 'study_psw' },
    ],
  },
  {
    countryCode: 'JP',
    ...
    flag: '🇯🇵',
    visas: [
      { id: 'jp_hsp', codeName: '高度专门职 1号', shortName: '高度人才积分制 (80分1年永住)', pillCategory: 'pr' },
      { id: 'jp_work', codeName: '技·人·国工签', shortName: '技术·人文知识·国际业务签证', pillCategory: 'work' },
      { id: 'jp_ssw', codeName: '特定技能 SSW', shortName: '特定技能蓝领实操签证 (2号转永住)', pillCategory: 'blue_collar' },
      { id: 'jp_designated_activities', codeName: '特定活动 找工签', shortName: '留学生就职找工签证 (最长1年)', pillCategory: 'opportunity' },
    ],
  },
  {
    countryCode: 'SG',
    ...
    flag: '🇸🇬',
    visas: [
      { id: 'sg_ep', codeName: 'EP (COMPASS)', shortName: 'COMPASS 40分制 (月薪$5.6k)', pillCategory: 'work' },
      { id: 'sg_spass', codeName: 'S Pass 准证', shortName: '中等技能工作准证 (月薪$3.15k)', pillCategory: 'work' },
      { id: 'sg_one_pass', codeName: 'ONE Pass', shortName: '顶级专才 5 年免雇主准证', pillCategory: 'talent' },
    ],
  },
  {
    countryCode: 'US',
    ...
    flag: '🇺🇸',
    visas: [
      { id: 'us_eb2_niw', codeName: 'EB-2 NIW 绿卡', shortName: '国家利益豁免 (理工硕博免雇主)', pillCategory: 'pr' },
      { id: 'us_o1a', codeName: 'O-1A 杰出人才', shortName: '杰出人才工作签证 (免抽签工签)', pillCategory: 'work' },
      { id: 'us_stem_opt', codeName: 'STEM OPT 3年', shortName: 'STEM 3年全职工作许可延期', pillCategory: 'study_psw' },
    ],
  },
  {
    countryCode: 'NL',
    ...
    flag: '🇳🇱',
    visas: [
      { id: 'nl_zoekjaar', codeName: 'Zoekjaar 找工签', shortName: 'Top 200 毕业生 1 年找工签', pillCategory: 'opportunity' },
      { id: 'nl_kennismigrant', codeName: '高技术移民工签', shortName: 'Kennismigrant (5年转永居/入籍)', pillCategory: 'work' },
    ],
  },
];

export interface PathwayRuleItem {
  id?: string;
  name: string;
  chineseName: string;
  ...
  isMandatory?: boolean;
  specialNoticeTag?: string;
  description: string;
  defaultChecked?: boolean;
}

export interface PathwayRuleCategory {
  category: string;
  selectionMode?: 'single' | 'multiple';
  items: PathwayRuleItem[];
}

export interface StatutoryPrerequisites {
  ageLimit: string;
  languageBenchmark: string;
  employerAccreditation: string;
  healthAndCharacter: string;
}
...
export interface LegalEvidenceTrail {
  operationalManualBasis: string;
  requiredEvidenceList: string[];
}

export interface SpecialTransitionNotice {
  title: string;
  content: string;
}
...
export interface PathwayMeta {
  ...
  specialTransitionNotice?: SpecialTransitionNotice;
  advisorVerdict?: AdvisorVerdict;
  prerequisites?: StatutoryPrerequisites;
  occupationGroups?: StatutoryOccupationGroup[];
  legalEvidence?: LegalEvidenceTrail;
  rules: PathwayRuleCategory[];
}

export const PATHWAYS_REGISTRY: Record<string, PathwayMeta> = {
  "nz_smc": {
    "id": "nz_smc",
    "code": "NZ",
    "countryName": "新西兰",
    "flag": "🇳🇿",
    "name": "新西兰 6分制技术移民居留签证",
    "englishName": "Skilled Migrant Category Resident Visa (6 Points)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "6 分及格",
    "numericThreshold": 6,
    ...
    "pswDuration": "审理周期: 6 - 9 个月",
    "processingTime": "6 - 9 个月",
    "keyRuleSummary": "通过学历、职业注册或高薪三选一主技能（最高6分），叠加本地工作经验，积满6分即可一步到位申请全家永久居留。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        "category": "一、 法定准入与核心指标",
        "items": [
          {
            "id": "nz_smc_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "6 分",
            "numericPoints": 6,
            "isMandatory": true,
            "defaultChecked": true,
            "description": "认证雇主全职工作且时薪达中位数 NZD $35.00/h"
          },
          {
            "id": "nz_smc_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "提供无犯罪记录公证书及体检合规证明。"
          }
        ]
      }
    ]
  ...
  "nz_green_list": {
    ...
    "countryName": "新西兰",
    "flag": "🇳🇿",
    "name": "新西兰绿名单直接居留签证 (Tier 1 STR)",
    "englishName": "Green List Straight to Residence Visa",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "100 分及格",
    "numericThreshold": 100,
    "isPointsBased": false,
    "officialDocUrl": "https://www.immigration.govt.nz/new-zealand-visas/visas/visa/straight-to-residence-visa",
    "officialFee": {
      "local": "NZD $4,290",
      "cnyEstimate": "约 ¥18,900",
      "amount": 4290,
    ...
    "pswDuration": "审理周期: 2 - 4 个月",
    "processingTime": "2 - 4 个月",
    "keyRuleSummary": "面向医生、护士、土木/电气/软件工程师、中学教师等战略紧缺人才，持有认证雇主对口 Offer 直接发放永久居留。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "时薪达中位数 NZD $35.00/h (部分需 $57.90/h)"
          },
          {
            "id": "nz_green_list_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "nz_aewv": {
    ...
    "countryName": "新西兰",
    "flag": "🇳🇿",
    "name": "新西兰认证雇主工作签证 (AEWV)",
    "englishName": "Accredited Employer Work Visa",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.immigration.govt.nz/new-zealand-visas/visas/visa/accredited-employer-work-visa",
    "officialFee": {
      "local": "NZD $750",
      "cnyEstimate": "约 ¥3,300",
      "amount": 750,
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "由新西兰认证雇主担保，通过劳动力市场测试（Job Check），具备 3 年行业经验或对口学历，英语达标后签发的技能工签。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "时薪达中位数 NZD $35.00/h (ANZSCO 4-5级需 $52.50/h)"
          },
          {
            "id": "nz_aewv_req_2",
            "name": "Health and Character Check",
  ...
  "nz_pswv": {
    ...
    "countryName": "新西兰",
    "flag": "🇳🇿",
    "name": "新西兰毕业生工作签证 (PSWV)",
    "englishName": "Post-study Work Visa",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.immigration.govt.nz/new-zealand-visas/visas/visa/post-study-work-visa",
    "officialFee": {
      "local": "NZD $1,670",
      "cnyEstimate": "约 ¥7,350",
      "amount": 1670,
    ...
    "pswDuration": "审理周期: 4 - 6 周",
    "processingTime": "4 - 6 周",
    "keyRuleSummary": "完成新西兰 Level 7+ 学位课程毕业后自动获批的开放式工签，硕士/博士直接享有 3 年开放工签，配偶同步享全职开放工签。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "开放工签无薪资门槛，自由受雇，配偶享全职开放工签"
          },
          {
            "id": "nz_pswv_req_2",
            "name": "Health and Character Check",
  ...
  "nz_whv": {
    ...
    "countryName": "新西兰",
    "flag": "🇳🇿",
    "name": "新西兰打工度假签证 (China Scheme)",
    "englishName": "China Working Holiday Visa",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.immigration.govt.nz/new-zealand-visas/visas/visa/china-working-holiday-visa",
    "officialFee": {
      "local": "NZD $420",
      "cnyEstimate": "约 ¥1,850",
      "amount": 420,
    ...
    "pswDuration": "审理周期: 2 - 4 周",
    "processingTime": "2 - 4 周",
    "keyRuleSummary": "每年面向中国青年发放 1000 个名额，允许在纽停留 12 个月进行打工、旅游与短期学习，低成本肉身出海与身份转换跳板。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "新西兰法定最低时薪 NZD $23.15/h 起，合法纳税"
          },
          {
            "id": "nz_whv_req_2",
            "name": "Health and Character Check",
  ...
  "nz_investor": {
    ...
    "flag": "🇳🇿",
    "name": "新西兰积极投资者加分居留签证",
    "englishName": "Active Investor Plus Visa",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.immigration.govt.nz/new-zealand-visas/visas/visa/active-investor-plus-visa",
    "officialFee": {
      "local": "NZD $7,900",
    ...
    "pswDuration": "审理周期: 4 - 8 个月",
    "processingTime": "4 - 8 个月",
    "keyRuleSummary": "面向高净值人群的直接居留签证，投资 500 万至 1500 万纽币于新西兰直投企业、私募基金或上市公司，3-4 年直接获得永久回头签。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "nz_investor_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "无本地工资要求，资金合法来源解释与投资合规证明"
          },
          {
            "id": "nz_investor_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "au_189": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚 189 独立技术移民永居签证",
    "englishName": "Skilled Independent Visa (Subclass 189)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "65 分及格",
    "numericThreshold": 65,
    "isPointsBased": true,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/skilled-independent-189",
    "officialFee": {
      "local": "AUD $4,640",
    ...
    "pswDuration": "审理周期: 3 - 9 个月",
    "processingTime": "3 - 9 个月",
    "keyRuleSummary": "澳洲技术移民纯打分通道，无需州担保和雇主绑定，凭个人在年龄、英语、学历、工作经验等打分择优受邀直接发 PR。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "无最低薪资强制要求，凭 Points Test 打分高低受邀"
          },
          {
            "id": "au_189_req_2",
            "name": "Health and Character Check",
  ...
  "au_190": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚 190 州政府担保技术永居签证",
    "englishName": "Skilled Nominated Visa (Subclass 190)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "65 分及格",
    "numericThreshold": 65,
    "isPointsBased": false,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/skilled-nominated-190",
    "officialFee": {
      "local": "AUD $4,640",
      "cnyEstimate": "约 ¥22,000",
      "amount": 4640,
    ...
    "pswDuration": "审理周期: 6 - 12 个月",
    "processingTime": "6 - 12 个月",
    "keyRuleSummary": "获得澳洲各州或领地政府提名自带 +5 分加分，需满足各州紧缺职业清单与定居承诺，获批即获永久居留。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "部分州担保要求本地 Offer 年薪 AUD $70,000+"
          },
          {
            "id": "au_190_req_2",
            "name": "Health and Character Check",
  ...
  "au_491": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚 491 偏远地区州担保临居转永居",
    "englishName": "Skilled Work Regional (Provisional) Visa (Subclass 491)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "65 分及格",
    "numericThreshold": 65,
    "isPointsBased": false,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/skilled-work-regional-491",
    "officialFee": {
      "local": "AUD $4,640",
      "cnyEstimate": "约 ¥22,000",
      "amount": 4640,
    ...
    "pswDuration": "审理周期: 6 - 14 个月",
    "processingTime": "6 - 14 个月",
    "keyRuleSummary": "偏远地区州担保自带 +15 分重磅加分，5 年临居签证，在偏远地区工作居住满 3 年可申请 191 永久居留绿卡。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "偏远地区居住工作3年，需保留纳税申报 ATO Notice"
          },
          {
            "id": "au_491_req_2",
            "name": "Health and Character Check",
  ...
  "au_482": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚 482 紧缺技能雇主担保工签",
    "englishName": "Temporary Skill Shortage Visa (Subclass 482 / Skills in Demand)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/temporary-skill-shortage-482",
    "officialFee": {
      "local": "AUD $3,115",
    ...
    "pswDuration": "审理周期: 1 - 3 个月",
    "processingTime": "1 - 3 个月",
    "keyRuleSummary": "受合规澳洲雇主担保，年薪达到 TSMIT $73,150 门槛，工作满 2 年可由雇主保荐 186 TRT 直转永久绿卡。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "法定最低年薪 TSMIT AUD $73,150/年"
          },
          {
            "id": "au_482_req_2",
            "name": "Health and Character Check",
  ...
  "au_485": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚 485 毕业生工作签证 (新政卡35岁)",
    "englishName": "Temporary Graduate Visa (Subclass 485 Post-Higher Education)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/temporary-graduate-485",
    "officialFee": {
      "local": "AUD $1,945",
      "cnyEstimate": "约 ¥9,200",
      "amount": 1945,
    ...
    "pswDuration": "审理周期: 1 - 3 个月",
    "processingTime": "1 - 3 个月",
    "keyRuleSummary": "完成 2 年全日制 CRICOS 课程享有 2-4 年工作许可。2026 改革将申请年龄上限由 50 岁严卡至 35 岁，语言提升至 6.5。",
    "advisorVerdict": {
  ...
  "au_858": {
    ...
    "countryName": "澳大利亚",
    "flag": "🇦🇺",
    "name": "澳大利亚国家创新签证 (原全球人才 GTI)",
    "englishName": "National Innovation Visa / Global Talent Visa (Subclass 858)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "100 分及格",
    "numericThreshold": 100,
    "isPointsBased": false,
    "officialDocUrl": "https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/global-talent-visa-858",
    "officialFee": {
      "local": "AUD $4,840",
    ...
    "pswDuration": "审理周期: 2 - 6 个月",
    "processingTime": "2 - 6 个月",
    "keyRuleSummary": "面向全球顶尖科技独角兽创始人、高引用学者与关键行业领军人物，免除打分与雇主，直接发放永久绿卡。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "需证明有能力达到高薪门槛 AUD $175,000/年"
          },
          {
            "id": "au_858_req_2",
            "name": "Health and Character Check",
  ...
  "ca_ee": {
    ...
    "countryName": "加拿大",
    "flag": "🇨🇦",
    "name": "加拿大联邦快速通道 (Express Entry CRS 打分)",
    "englishName": "Express Entry (Comprehensive Ranking System CRS)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "480 分及格",
    "numericThreshold": 480,
    "isPointsBased": true,
    ...
    "pswDuration": "审理周期: 6 个月",
    "processingTime": "6 个月",
    "keyRuleSummary": "涵盖联邦技术 FSW、经验类 CEC 与技工 FST，通过年龄、双语、学历及本地经验综合排分，定向邀请 STEM、医疗、法语大军。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "需达到 TEER 0/1/2/3 对应岗位要求"
          },
          {
            "id": "ca_ee_req_2",
            "name": "Health and Character Check",
  ...
  "ca_pnp_tech": {
    ...
    "countryName": "加拿大",
    "flag": "🇨🇦",
    "name": "加拿大省提名科技与硕博通道 (BC Tech / OINP)",
    "englishName": "Provincial Nominee Program (BC PNP Tech & Ontario Masters)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "100 分及格",
    "numericThreshold": 100,
    "isPointsBased": false,
    "officialDocUrl": "https://www.welcomebc.ca/immigrate-to-b-c/bc-pnp-tech",
    "officialFee": {
      "local": "CAD $1,475",
      "cnyEstimate": "约 ¥7,800",
      "amount": 1475,
    ...
    "pswDuration": "审理周期: 6 - 12 个月",
    "processingTime": "6 - 12 个月",
    "keyRuleSummary": "各省针对理工紧缺 IT/工程及公立名校硕博毕业生的特快直通车，省提名获批直接获得 EE +600 分保送或直接递交联邦永居。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "符合省内同工同酬中位数"
          },
          {
            "id": "ca_pnp_tech_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "ca_pgwp": {
    ...
    "countryName": "加拿大",
    "flag": "🇨🇦",
    "name": "加拿大毕业后工签 (PGWP 语言与专业新规)",
    "englishName": "Post-Graduation Work Permit (PGWP 2026 Revision)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.canada.ca/en/immigration-refugees-citizenship/services/study-canada/work/after-graduation.html",
    "officialFee": {
      "local": "CAD $255",
      "cnyEstimate": "约 ¥1,350",
      "amount": 255,
    ...
    "pswDuration": "审理周期: 2 - 4 个月",
    "processingTime": "2 - 4 个月",
    "keyRuleSummary": "指定 DLI 高校毕业后签发最长 3 年开放工签，2026 新政强化了公立大学硕博直接发 3 年，College 课程需对口紧缺专业并考语言。",
    "advisorVerdict": {
  ...
  "ca_suv": {
    ...
    "countryName": "加拿大",
    "flag": "🇨🇦",
    "name": "加拿大联邦创业投资移民 (Start-up Visa)",
    "englishName": "Start-up Visa Program",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/start-visa.html",
    "officialFee": {
      "local": "CAD $2,385",
    ...
    "pswDuration": "审理周期: 12 - 24 个月",
    "processingTime": "12 - 24 个月",
    "keyRuleSummary": "获得加拿大指定风投基金、天使投资组织或孵化器支持信（Letter of Support），最多 5 位核心创始人一步到位全家拿枫叶卡。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "需具备满足家庭人数要求的充裕创业与安家资金"
          },
          {
            "id": "ca_suv_req_2",
            "name": "Health and Character Check",
  ...
  "de_blue_card": {
    ...
    "countryName": "德国",
    "flag": "🇩🇪",
    "name": "德国欧盟蓝卡 (§18g 降门槛与IT免学历版)",
    "englishName": "EU Blue Card Germany (AufenthG §18g)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "本科以上学历或 3 年 IT 实战经验，年薪达 €45,300 (常规) 或 €41,041 (紧缺)，交社保 21-27 个月直发德国永久居留。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "de_blue_card_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "常规职位 €45,300/年，STEM/医疗等紧缺 €41,041/年"
          },
          {
            "id": "de_blue_card_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "de_ausbildung": {
    ...
    "countryName": "德国",
    "flag": "🇩🇪",
    "name": "德国双元制职业培训与就业移民 (§16a)",
    "englishName": "German Dual Vocational Training (Ausbildung §16a)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.make-it-in-germany.com/en/study-training/training-in-germany",
    "officialFee": {
      "local": "EUR €75",
      "cnyEstimate": "约 ¥590",
      "amount": 75,
    ...
    "pswDuration": "审理周期: 4 - 12 周",
    "processingTime": "4 - 12 周",
    "keyRuleSummary": "免学费带薪就读护理、机电、IT 等双元制（每月津贴 €1,000~1,500），毕业获德国国家职业资格证书并直签全职合同，2 年拿德国永居。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "de_ausbildung_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "培训期间月薪津贴 €1,000 - €1,500/月，毕业后按法定同工同酬"
          },
          {
            "id": "de_ausbildung_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "de_chancenkarte": {
    ...
    "countryName": "德国",
    "flag": "🇩🇪",
    "name": "德国机会卡积分找工签证 (§20a 6分及格)",
    "englishName": "German Opportunity Card (Chancenkarte §20a)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "6 分及格",
    "numericThreshold": 6,
    "isPointsBased": true,
    "officialDocUrl": "https://www.make-it-in-germany.com/en/visa-residence/types/opportunity-card",
    "officialFee": {
      "local": "EUR €75",
      "cnyEstimate": "约 ¥590",
      "amount": 75,
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "2024 年 6 月正式启用的打分制找工签证。满 6 分直接获发 1 年居留赴德自由找工，允许每周 20 小时兼职与试工。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "赴德前需存入限制性自保金账户约 €1,027/月"
          },
          {
            "id": "de_chancenkarte_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "fr_talent_passport": {
    ...
    "countryName": "法国",
    "flag": "🇫🇷",
    "name": "法国优秀人才护照 (Passeport Talent 4年卡)",
    "englishName": "French Talent Passport (Talent - Salarié qualifié)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://france-visas.gouv.fr/en/web/france-visas/international-talents",
    "officialFee": {
      "local": "EUR €225",
      "cnyEstimate": "约 ¥1,760",
      "amount": 225,
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "拥有法国本硕学历或受雇于创新企业 (JEI)，年薪达到法定毛薪 2 倍 (€43,300+)，直接获批 4 年期居留，家属享全职工作许可。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "fr_talent_passport_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "年薪达到 2 倍 SMIC (约 €43,300/年)"
          },
          {
            "id": "fr_talent_passport_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "fr_rece": {
    ...
    "countryName": "法国",
    "flag": "🇫🇷",
    "name": "法国毕业求职与创业居留 (RECE 1年找工)",
    "englishName": "French Job Search / Business Creation Visa (RECE)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.service-public.fr/particuliers/vosdroits/F17319",
    "officialFee": {
      "local": "EUR €75",
      "cnyEstimate": "约 ¥590",
      "amount": 75,
    ...
    "pswDuration": "审理周期: 4 - 6 周",
    "processingTime": "4 - 6 周",
    "keyRuleSummary": "获得法国认可硕士以上学位或 Grande École 文凭，毕业后享 12 个月居留寻找与专业对口的高薪工作或在法创立科技企业。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "找工期间可从事不超过60%年工时兼职，转工签薪资需达 1.5倍 SMIC"
          },
          {
            "id": "fr_rece_req_2",
            "name": "Health and Character Check",
  ...
  "se_work_permit": {
    ...
    "countryName": "瑞典",
    "flag": "🇸🇪",
    "name": "瑞典工作许可 (高薪中位数 €3,000+ 新政)",
    "englishName": "Swedish Work Permit (Utlänningslagen 6 kap)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 2 - 4 个月",
    "processingTime": "2 - 4 个月",
    "keyRuleSummary": "由在瑞典合法注册雇主提供工会认证劳动合同，月薪达瑞典中位数 80% (SEK 34,200/月)，连续工作 4 年可申请瑞典永久居留。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "se_work_permit_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "月薪不低于 SEK 34,200/月 (瑞典薪资中位数 80%)"
          },
          {
            "id": "se_work_permit_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "se_job_seeker": {
    ...
    "countryName": "瑞典",
    "flag": "🇸🇪",
    "name": "瑞典高学历找工居留 (9个月找工/创业)",
    "englishName": "Swedish Residence Permit for Job Seeking (Advanced Degree)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.migrationsverket.se/English/Private-individuals/Working-in-Sweden/Look-for-work-or-start-a-business.html",
    "officialFee": {
      "local": "SEK 2,200",
      "cnyEstimate": "约 ¥1,520",
      "amount": 2200,
    ...
    "pswDuration": "审理周期: 2 - 3 个月",
    "processingTime": "2 - 3 个月",
    "keyRuleSummary": "持有经认证的硕士或博士学位，提供生活保障资金与全额商业医疗保险，可获发最长 9 个月居留在瑞典寻找高技能工作。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "se_job_seeker_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "找工期间需具备每月至少 SEK 13,000 的自备资金证明"
          },
          {
            "id": "se_job_seeker_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "dk_positive_list": {
    ...
    "countryName": "丹麦",
    "flag": "🇩🇰",
    "name": "丹麦紧缺清单高技能工作计划 (Positive List)",
    "englishName": "Danish Positive List for Highly Educated / Skilled",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.nyidanmark.dk/en-GB/You-want-to-apply/Work/Positive-Lists",
    "officialFee": {
      "local": "DKK 6,290",
      "cnyEstimate": "约 ¥6,600",
      "amount": 6290,
    ...
    "pswDuration": "审理周期: 1 个月",
    "processingTime": "1 个月",
    "keyRuleSummary": "受聘于丹麦紧缺职业清单（IT、工程、医疗、生命科学等），薪资符合丹麦行业集体谈判协议标准，极速批复全家工作居留。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "dk_positive_list_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "符合丹麦行业集体协议同工同酬标准"
          },
          {
            "id": "dk_positive_list_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "dk_pay_limit": {
    ...
    "countryName": "丹麦",
    "flag": "🇩🇰",
    "name": "丹麦高薪计划 (Pay Limit Scheme €5.2万欧)",
    "englishName": "Danish Pay Limit Scheme (Supplementary DKK 393k+)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.nyidanmark.dk/en-GB/You-want-to-apply/Work/Pay-limit-scheme",
    "officialFee": {
      "local": "DKK 6,290",
      "cnyEstimate": "约 ¥6,600",
      "amount": 6290,
    ...
    "pswDuration": "审理周期: 1 个月 (极速审理)",
    "processingTime": "1 个月 (极速审理)",
    "keyRuleSummary": "不限职业类别与学历专业，只要丹麦雇主提供的全职合同年薪达到 DKK 393,000+ (约合人民币 41 万)，直接极速批复工签。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "dk_pay_limit_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "年薪至少 DKK 393,000/年 (补充通道) 或 DKK 487,000/年 (标准通道)"
          },
          {
            "id": "dk_pay_limit_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "dk_establishment": {
    ...
    "countryName": "丹麦",
    "flag": "🇩🇰",
    "name": "丹麦毕业定居创业居留卡 (Establishment Card)",
    "englishName": "Danish Establishment Card (Post-Graduation)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.nyidanmark.dk/en-GB/You-want-to-apply/Work/Establishment-card",
    "officialFee": {
      "local": "DKK 3,450",
      "cnyEstimate": "约 ¥3,600",
      "amount": 3450,
    ...
    "pswDuration": "审理周期: 1 - 2 个月",
    "processingTime": "1 - 2 个月",
    "keyRuleSummary": "在丹麦完成受认可的硕士或博士学位，毕业后直接申请最长 2-3 年的定居卡，享有完全自由的找工与创业权限。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "dk_establishment_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "找工期间无薪资门槛，自由受雇与创业"
          },
          {
            "id": "dk_establishment_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "fi_specialist": {
    ...
    "countryName": "芬兰",
    "flag": "🇫🇮",
    "name": "芬兰专家级高技术工作居留 (14天极速通道)",
    "englishName": "Finnish Residence Permit for Specialists (Fast-Track 14 Days)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 14 天 (Fast-Track)",
    "processingTime": "14 天 (Fast-Track)",
    "keyRuleSummary": "持有高等学历的高技能专家、IT 工程师、管理人才，月薪达 €3,638+，享有芬兰 14 天极速审批（Fast Track）与全家定居。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "fi_specialist_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "月薪不低于 EUR €3,638/月 (税前总薪资)"
          },
          {
            "id": "fi_specialist_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "fi_post_study": {
    ...
    "countryName": "芬兰",
    "flag": "🇫🇮",
    "name": "芬兰毕业生找工与创业居留 (2年开放签)",
    "englishName": "Finnish Residence Permit for Graduates (2 Years)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://migri.fi/en/residence-permit-to-look-for-work",
    "officialFee": {
      "local": "EUR €380",
      "cnyEstimate": "约 ¥2,980",
      "amount": 380,
    ...
    "pswDuration": "审理周期: 1 - 2 个月",
    "processingTime": "1 - 2 个月",
    "keyRuleSummary": "在芬兰完成高等教育学位或科研项目，毕业后可申请长达 2 年的开放式找工与创业居留，可分段在 5 年内使用。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "fi_post_study_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "需具备至少 €6,720/年的基础生活保障资金证明"
          },
          {
            "id": "fi_post_study_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "uk_skilled_worker": {
    ...
    "countryName": "GB",
    "flag": "🌐",
    "name": "英国技术工人工作签证 (2024新政 £38,700 门槛)",
    "englishName": "UK Skilled Worker Visa (2024 £38.7k Threshold)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "70 分及格",
    "numericThreshold": 70,
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 3 - 8 周",
    "processingTime": "3 - 8 周",
    "keyRuleSummary": "受合规英国内政部持牌雇主担保，年薪达 £38,700 门槛（或紧缺列表折扣），5 年合规连续纳税可申请英国永居 ILR。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "通用年薪底线 £38,700/年 (或各行业 Going Rate 孰高)"
          },
          {
            "id": "uk_skilled_worker_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "uk_graduate_visa": {
    ...
    "countryName": "GB",
    "flag": "🌐",
    "name": "英国毕业生工作签证 (Graduate Visa / PSW)",
    "englishName": "UK Graduate Visa (2-3 Year Post-Study Work)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.gov.uk/graduate-visa",
    "officialFee": {
      "local": "GBP £822 + IHS",
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "在英完成受认可高等学位，本科/硕士直接获发 2 年全职开放工签，博士享有 3 年工签，无需雇主担保，自由工作与创业。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "uk_graduate_visa_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "开放工签无薪资门槛，自由受雇，不可直接计入5年ILR"
          },
          {
            "id": "uk_graduate_visa_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "uk_hpi": {
    ...
    "countryName": "GB",
    "flag": "🌐",
    "name": "英国高潜力人才签证 (全球Top 50名校直发)",
    "englishName": "High Potential Individual (HPI) Visa",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.gov.uk/high-potential-individual-visa",
    "officialFee": {
    ...
    "pswDuration": "审理周期: 3 - 8 周",
    "processingTime": "3 - 8 周",
    "keyRuleSummary": "近 5 年内毕业于全球 Top 50 顶尖大学（含清华、北大等），无需英国内部雇主 Job Offer，直接发放 2-3 年全职工作签证。",
    "advisorVerdict": {
  ...
  "uk_global_talent": {
    ...
    "countryName": "GB",
    "flag": "🌐",
    "name": "英国全球人才签证 (Tech Nation / 皇家学会背书)",
    "englishName": "UK Global Talent Visa (Tech Nation / Royal Society)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.gov.uk/global-talent",
    "officialFee": {
      "local": "GBP £716 + 背书费",
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "数字科技、科学研究、艺术文化领域领军或潜力人才，获得指定官方机构背书，免除雇主绑定，3 年极速拿到英国永居 ILR。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "uk_global_talent_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "无强制薪资要求，凭行业重大贡献与背书信"
          },
          {
            "id": "uk_global_talent_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "ie_csep": {
    ...
    "countryName": "爱尔兰",
    "flag": "🇮🇪",
    "name": "爱尔兰关键技能工作许可 (CSEP 2年直转Stamp 4永居)",
    "englishName": "Irish Critical Skills Employment Permit (CSEP)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 6 - 10 周",
    "processingTime": "6 - 10 周",
    "keyRuleSummary": "紧缺职业年薪 €38,000+ 或非紧缺高薪 €64,000+，全职工作满 2 年直接换发 Stamp 4 自由永居卡，配偶享有完全自由合法工作权。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "紧缺职业清单职位 €38,000/年 (2025起€44,000)，其他职位 €64,000/年"
          },
          {
            "id": "ie_csep_req_2",
            "name": "Health and Character Check",
  ...
  "ie_stamp1g": {
    ...
    "countryName": "爱尔兰",
    "flag": "🇮🇪",
    "name": "爱尔兰毕业生求职工作签证 (Stamp 1G 硕士2年)",
    "englishName": "Irish Third Level Graduate Scheme (Stamp 1G)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.irishimmigration.ie/my-situation-has-changed-since-i-arrived-in-ireland/third-level-graduate-programme/",
    "officialFee": {
      "local": "EUR €300",
      "cnyEstimate": "约 ¥2,350",
      "amount": 300,
    ...
    "pswDuration": "审理周期: 4 - 6 周",
    "processingTime": "4 - 6 周",
    "keyRuleSummary": "爱尔兰大学本科毕业获 1 年、硕士/博士毕业直接获 2 年 Stamp 1G 全职工作许可，无需雇主担保，在此期间对接企业转 CSEP 工签。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "每周可合法全职工作 40 小时，无薪资门槛要求"
          },
          {
            "id": "ie_stamp1g_req_2",
            "name": "Health and Character Check",
  ...
  "jp_hsp": {
    ...
    "countryName": "日本",
    "flag": "🇯🇵",
    "name": "日本高度人才专门职积分签证 (70/80分 1~3年永住)",
    "englishName": "Japan Highly Skilled Professional (HSP Points Visa)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "70 分及格",
    "numericThreshold": 70,
    "isPointsBased": true,
    "officialDocUrl": "https://www.moj.go.jp/isa/publications/materials/nyuukokukanri07_00016.html",
    "officialFee": {
      "local": "JPY ¥4,000",
      "cnyEstimate": "约 ¥190",
      "amount": 4000,
    ...
    "pswDuration": "审理周期: 1 - 2 个月",
    "processingTime": "1 - 2 个月",
    "keyRuleSummary": "在学历、年收入、工作年限、日语能力等打分达 70 分 3 年转永住，达到 80 分仅需 1 年极速直拿日本永久居留权。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "技术/业务类必须满足保底年收 ¥300万日元 (依年龄阶梯加分)"
          },
          {
            "id": "jp_hsp_req_2",
            "name": "Health and Character Check",
  ...
  "jp_work": {
    ...
    "countryName": "日本",
    "flag": "🇯🇵",
    "name": "日本技人国常规工作签证 (技术·人文知识·国际业务)",
    "englishName": "Japan Engineer / Specialist in Humanities / International Services",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.moj.go.jp/isa/applications/status/gijinkoku.html",
    "officialFee": {
      "local": "JPY ¥4,000",
      "cnyEstimate": "约 ¥190",
      "amount": 4000,
    ...
    "pswDuration": "审理周期: 1 - 3 个月",
    "processingTime": "1 - 3 个月",
    "keyRuleSummary": "白领核心就劳签证：大专本科以上学历或 10 年从业经验，受聘于日本企业从事软件研发、商务翻译、财务营销等，连续工作 5 年归化入籍或 10 年永住。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "薪资待遇不得低于同等岗位日本本土员工报酬 (同工同酬)"
          },
          {
            "id": "jp_work_req_2",
            "name": "Health and Character Check",
  ...
  "jp_ssw": {
    ...
    "countryName": "日本",
    "flag": "🇯🇵",
    "name": "日本特定技能 1号/2号 蓝领紧缺技能签证",
    "englishName": "Japan Specified Skilled Worker (SSW (i) / (ii))",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.moj.go.jp/isa/applications/status/specifiedskilledworker.html",
    "officialFee": {
      "local": "JPY ¥4,000",
      "cnyEstimate": "约 ¥190",
      "amount": 4000,
    ...
    "pswDuration": "审理周期: 1 - 3 个月",
    "processingTime": "1 - 3 个月",
    "keyRuleSummary": "面向介护、餐饮、制造、建筑等 12 大紧缺行业，通过技能与日语 N4 考试赴日工作。特定技能 2 号无停留上限，可携家属并申请日本永住。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "享受法定最低薪资与同工同酬保障，强制缴纳厚生年金与健康保险"
          },
          {
            "id": "jp_ssw_req_2",
            "name": "Health and Character Check",
  ...
  "jp_designated_activities": {
    "id": "jp_designated_activities",
    "code": "JP",
    "countryName": "日本",
    "flag": "🇯🇵",
    "name": "日本留学生毕业求职特定活动签证 (最长1年找工)",
    "englishName": "Japan Designated Activities for Job Hunting (留学生找工签)",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.moj.go.jp/isa/applications/status/designatedactivities14.html",
    "officialFee": {
      "local": "JPY ¥4,000",
      "cnyEstimate": "约 ¥190",
      "amount": 4000,
    ...
    "pswDuration": "审理周期: 2 - 4 周",
    "processingTime": "2 - 4 周",
    "keyRuleSummary": "日本大学/专门学校毕业未拿到 Offer 者，由学校推荐获发 6 个月特定活动居留，可续签一次最长 1 年，期间可每周兼职 28 小时继续找工作。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "jp_designated_activities_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "需取得就读大学的正式推荐信与求职活动记录"
          },
          {
            "id": "jp_designated_activities_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "sg_ep": {
    ...
    "countryName": "新加坡",
    "flag": "🇸🇬",
    "name": "新加坡 EP 高级就业准证 (COMPASS 互补积分制)",
    "englishName": "Singapore Employment Pass (COMPASS Points Framework)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "40 分及格",
    "numericThreshold": 40,
    "isPointsBased": true,
    ...
    "pswDuration": "审理周期: 1 - 3 周",
    "processingTime": "1 - 3 周",
    "keyRuleSummary": "月薪达 SGD $5,600+ (金融业 $6,200+)，并在薪资、学历、雇主多元化、本地人支持四大维度通过 COMPASS 打分满 40 分获批。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "起步月薪 SGD $5,600/月 (40岁以上最高至 $10,700/月)"
          },
          {
            "id": "sg_ep_req_2",
            "name": "Health and Character Check",
  ...
  "sg_spass": {
    ...
    "countryName": "新加坡",
    "flag": "🇸🇬",
    "name": "新加坡 S Pass 中级技术准证 (配额与劳工税机制)",
    "englishName": "Singapore S Pass (Mid-Level Skilled Staff)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.mom.gov.sg/passes-and-permits/s-pass",
    "officialFee": {
      "local": "SGD $175",
      "cnyEstimate": "约 ¥950",
      "amount": 175,
    ...
    "pswDuration": "审理周期: 1 - 3 周",
    "processingTime": "1 - 3 周",
    "keyRuleSummary": "面向中级技术人员与专业技师，月薪达 SGD $3,150+ (金融业 $3,650+)，受雇主行业外劳配额（Quota）与月缴人头税（Levy）管控。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "法定最低月薪 SGD $3,150/月 (随年龄递增至最高 $4,650/月)"
          },
          {
            "id": "sg_spass_req_2",
            "name": "Health and Character Check",
  ...
  "sg_one_pass": {
    ...
    "countryName": "新加坡",
    "flag": "🇸🇬",
    "name": "新加坡顶级专才准证 (ONE Pass 5年免绑雇主)",
    "englishName": "Singapore Overseas Networks & Expertise Pass (ONE Pass)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "100 分及格",
    "numericThreshold": 100,
    "isPointsBased": false,
    "officialDocUrl": "https://www.mom.gov.sg/passes-and-permits/overseas-networks-expertise-pass",
    "officialFee": {
      "local": "SGD $480",
      "cnyEstimate": "约 ¥2,600",
      "amount": 480,
    ...
    "pswDuration": "审理周期: 4 - 8 周",
    "processingTime": "4 - 8 周",
    "keyRuleSummary": "面向全球顶尖商业、科技、文化体育领军人物，月薪达 SGD $30,000+ 或在知名企业取得卓越成就，发放 5 年期自由工作居留，可同时创办并受雇于多家公司。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "过去1年或受雇薪资需达到月薪 SGD $30,000/月 (或在科技/商业有杰出成就)"
          },
          {
            "id": "sg_one_pass_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "us_eb2_niw": {
    ...
    "countryName": "美国",
    "flag": "🇺🇸",
    "name": "美国 EB-2 NIW 国家利益豁免绿卡",
    "englishName": "National Interest Waiver (EB-2 NIW Green Card)",
    "category": "永久居留 (PR)",
    "pillCategory": "pr",
    "passThreshold": "100 分及格",
    "numericThreshold": 100,
    "isPointsBased": false,
    "officialDocUrl": "https://www.uscis.gov/working-in-the-united-states/permanent-workers/employment-based-immigration-second-preference-eb-2",
    "officialFee": {
      "local": "USD $715",
      "cnyEstimate": "约 ¥5,150",
      "amount": 715,
    ...
    "pswDuration": "审理周期: 45 天加急 + 排期",
    "processingTime": "45 天加急 + 排期",
    "keyRuleSummary": "理工高学历出海大杀器：硕士以上学历免除劳工证 PERM 与雇主担保，直接由申请人向 USCIS 提交申请永久绿卡。",
    "advisorVerdict": {
        ...
        "items": [
          {
            ...
            "isMandatory": true,
            "defaultChecked": true,
            "description": "无强制雇主薪资要求，凭学术实质贡献与国家利益论证"
          },
          {
            "id": "us_eb2_niw_req_2",
            "name": "Health and Character Check",
  ...
  "us_o1a": {
    ...
    "countryName": "美国",
    "flag": "🇺🇸",
    "name": "美国 O-1A 杰出人才工作签证 (免抽签工签)",
    "englishName": "O-1A Visa: Individuals with Extraordinary Ability in Sciences",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.uscis.gov/working-in-the-united-states/temporary-workers/o-1-visa-individuals-with-extraordinary-ability-or-achievement",
    "officialFee": {
      "local": "USD $1,055",
      "cnyEstimate": "约 ¥7,600",
      "amount": 1055,
    ...
    "pswDuration": "审理周期: 15 天加急",
    "processingTime": "15 天加急",
    "keyRuleSummary": "科学、教育、商业或体育领域的杰出人才签证，无名额配额限制、无抽签风险，获批即可享有 3 年工作许可并可无限期续签。",
    "advisorVerdict": {
  ...
  "us_stem_opt": {
    ...
    "countryName": "美国",
    "flag": "🇺🇸",
    "name": "美国 STEM 专业 3 年 OPT 工作许可延期",
    "englishName": "F-1 STEM OPT 24-Month Extension",
    "category": "留学/工签",
    "pillCategory": "opportunity",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://www.uscis.gov/working-in-the-united-states/students-and-exchange-visitors/optional-practical-training-extension-for-stem-students-stem-opt",
    "officialFee": {
      "local": "USD $470",
      "cnyEstimate": "约 ¥3,380",
      "amount": 470,
    ...
    "pswDuration": "审理周期: 2 - 3 个月",
    "processingTime": "2 - 3 个月",
    "keyRuleSummary": "STEM 领域本硕博毕业生享有 12+24 个月全职工作许可，提供多达 3-4 次 H-1B 抽签机会与 NIW 绿卡准备期。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "us_stem_opt_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "必须在 E-Verify 合规雇主处受聘"
          },
          {
            "id": "us_stem_opt_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "nl_zoekjaar": {
    ...
    "countryName": "荷兰",
    "flag": "🇳🇱",
    "name": "荷兰搜寻年找工签证 (Zoekjaar / Top 200名校直发)",
    "englishName": "Netherlands Orientation Year Visa (Zoekjaar)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    "officialDocUrl": "https://ind.nl/en/residence-permits/work/orientation-year-highly-educated-persons",
    "officialFee": {
      "local": "EUR €228",
      "cnyEstimate": "约 ¥1,780",
      "amount": 228,
    ...
    "pswDuration": "审理周期: 2 - 4 周",
    "processingTime": "2 - 4 周",
    "keyRuleSummary": "世界 Top 200 大学毕业生 3 年内均可申请 1 年无条件找工签，找到工作转高技术移民享薪资减免优惠（仅需 €2,865/月）。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "nl_zoekjaar_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "找工期间无薪资门槛，转工签享优惠薪资 €2,865/月"
          },
          {
            "id": "nl_zoekjaar_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
  ...
  "nl_kennismigrant": {
    ...
    "countryName": "荷兰",
    "flag": "🇳🇱",
    "name": "荷兰高技术移民工作许可 (IND 认证雇主)",
    "englishName": "Highly Skilled Migrant Visa (Kennismigrant)",
    "category": "工作签证 (Work Visa)",
    "pillCategory": "work",
    "passThreshold": "合规雇主担保 / 薪资达标",
    "isPointsBased": false,
    ...
    "pswDuration": "审理周期: 2 - 4 周",
    "processingTime": "2 - 4 周",
    "keyRuleSummary": "受 IND 认可雇主聘用，30岁以上月薪 €5,420，30岁以下 €3,972，连续纳税满 5 年并通过融入考试可直接申请荷兰永久居留或入籍。",
    "advisorVerdict": {
    ...
    "rules": [
      {
        ...
        "items": [
          {
            "id": "nl_kennismigrant_req_1",
            "name": "Statutory Core Requirement",
            "chineseName": "满足官方首要准入门槛",
            "points": "核心要求",
            "isMandatory": true,
            "defaultChecked": true,
            "description": "30岁以上 €5,420/月，30岁以下 €3,972/月 (Zoekjaar减免至 €2,865/月)"
          },
          {
            "id": "nl_kennismigrant_req_2",
            "name": "Health and Character Check",
            "chineseName": "无重大犯罪记录与体检合规",
            "points": "法定必选",
            "isMandatory": true,
...
if (PATHWAYS_REGISTRY.ca_ee) {
  PATHWAYS_REGISTRY['ca_ee_fsw'] = PATHWAYS_REGISTRY.ca_ee;
}
if (PATHWAYS_REGISTRY.uk_skilled_worker) {
  PATHWAYS_REGISTRY['uk_swv'] = PATHWAYS_REGISTRY.uk_skilled_worker;
}
if (PATHWAYS_REGISTRY.us_eb2_niw) {
  PATHWAYS_REGISTRY['us_niw'] = PATHWAYS_REGISTRY.us_eb2_niw;
}
if (PATHWAYS_REGISTRY.sg_ep) {
  PATHWAYS_REGISTRY['sg_compass'] = PATHWAYS_REGISTRY.sg_ep;
}
